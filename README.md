...
git clone https://github.com/preetikulk/product-crud-api-tests.git
cd product-crud-api-tests
...
- [EXECUTION_REPORT.md](EXECUTION_REPORT.md) - Visual test execution summary
